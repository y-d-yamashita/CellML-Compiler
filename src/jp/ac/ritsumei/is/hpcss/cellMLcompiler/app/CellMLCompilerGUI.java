...
public class CellMLCompilerGUI extends JFrame {
    ...
    private void exec() {
    	...
    	if (cRadioButton.isSelected()) {
    		genCode = CellMLCompilerMain.GENERATOR_COMMON;
    	} else if (cudaRadioButton.isSelected()) {
    		genCode = CellMLCompilerMain.GENERATOR_CUDA;
    	} else if (simpleRadioButton.isSelected()) {
    		genCode = CellMLCompilerMain.GENERATOR_SIMPLE;
    	} else if (javaRadioButton.isSelected()) {
    		genCode = CellMLCompilerMain.GENERATOR_JAVA;
    	} else if (javaBigDecimalRadioButton.isSelected()) {
    		genCode = CellMLCompilerMain.GENERATOR_JAVA_BIGDECIMAL;
    	}
