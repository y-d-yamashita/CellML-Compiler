...
public class DecisionLoopStructure {
	...
	public ArrayList<RelationPath> get_LoopStructure(ArrayList<ArrayList<RelationPath>> combinationList, int indexListsize, ArrayList<RelationPath>  inputList){
	...
	public ArrayList<ArrayList<RelationPath>> reduce_combinationList_3rd(ArrayList<ArrayList<RelationPath>> combinationList, int indexListsize){
	...
	public ArrayList<ArrayList<RelationPath>> reduce_combinationList_2nd(ArrayList<ArrayList<RelationPath>> combinationList, int indexListsize){
	...
	public ArrayList<ArrayList<RelationPath>> reduce_combinationList_1st(ArrayList<ArrayList<RelationPath>> combinationList, int indexListsize){
	...
	public ArrayList<ArrayList<RelationPath>> get_combinationList(ArrayList<RelationPath> patternList,HashMap<Integer, String> IndexList){
    ...
    public void combine_pattern( int m ,int n,int r,int[] c,ArrayList<RelationPath> patternList,ArrayList<ArrayList<RelationPath>> combinationList) {
	...
	public ArrayList<RelationPath> get_relationList(HashMap<Integer, String> IndexList){
