...
public class Math_and extends MathOperator {
	...
	/*-----コンストラクタ-----*/
	public Math_and(String[] strAttr) {
		super("&&", eMathOperator.MOP_AND, MathMLDefinition.MATH_OPERATOR_MIN_FACTOR_AND, strAttr);
	}
	...
	public String toLegalString() throws MathException {
		...
		/*被演算子の個数チェック*/
		if(m_vecFactor.size() < MathMLDefinition.MATH_OPERATOR_MIN_FACTOR_AND){
			throw new MathException("Math_and","toLegalString","lack of operand");
		}
	...
	public String toMathMLString() throws MathException {
		...
		/*被演算子の個数チェック*/
		if(m_vecFactor.size() < MathMLDefinition.MATH_OPERATOR_MIN_FACTOR_AND){
			throw new MathException("Math_and","toMathMLString","lack of operand");
		}
