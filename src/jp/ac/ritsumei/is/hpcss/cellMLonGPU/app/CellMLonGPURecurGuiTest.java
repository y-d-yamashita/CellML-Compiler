...
public class CellMLonGPURecurGuiTest  extends JFrame {
...
//	private JRadioButton javaBigDecimalRadioButton;
	...
	public static void main(String[] args) {
		new CellMLonGPURecurGuiTest().setVisible(true);
	}
	
	/**
	 * インスタンスを作成し数式展開システムGUI版を実行する.
	 */
	public CellMLonGPURecurGuiTest() {
		super("数式展開プログラム");
...
//		}
    	...
    	if (gRustyButton.isSelected()) {
    		genCode0 = CellMLonGPURecurMainTest.GENERATOR_RUSTY;
    	}else if(gKawabataButton.isSelected()){
    		genCode0 = CellMLonGPURecurMainTest.GENERATOR_KAWABATA;
    	}

    	/*生成系2*/
    	String genCode1 = null;
    	if (rSimpleButton.isSelected()) {
    		genCode1 = CellMLonGPURecurMainTest.FILETYPE_SIMPLE;
    	}else if(rStructuredButton.isSelected()){
    		genCode1 = CellMLonGPURecurMainTest.FILETYPE_STRUCTURED;    		
    	}else if(rRelmlButton.isSelected()){
    		genCode1 = CellMLonGPURecurMainTest.FILETYPE_RELML;
    	}
