 ...
 */
public class CudaRecurrenceInitKernelGenerator extends CudaProgramGenerator {
	 ...
	 */
	public CudaRecurrenceInitKernelGenerator(CellMLAnalyzer pCellMLAnalyzer,
	...
	throws MathException {
		...
		//		(Math_ci)MathFactory.createOperand(eMathOperand.MOPD_CI,
			//m_pRecMLAnalyzer.getM_.toLegalString());
