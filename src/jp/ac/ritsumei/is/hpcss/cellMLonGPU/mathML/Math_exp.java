...
public class Math_exp extends MathOperator {
	...
	public String toLegalJavaString() throws MathException {
		...
		/*被演算子の個数チェック*/
		if(m_vecFactor.size() < MathMLDefinition.MATH_OPERATOR_MIN_FACTOR_EXP) {
			throw new MathException("Math_exp","toLegalJavaString","lack of operand");
		}

		return "Math.exp( " + m_vecFactor.get(0).toLegalJavaString() + " )";
	}
	...
	public String toMathMLString() throws MathException {
		...
		/*被演算子の個数チェック*/
		if(m_vecFactor.size() != MathMLDefinition.MATH_OPERATOR_MIN_FACTOR_EXP) {
			throw new MathException("Math_exp","toMathMLString","lack of operand");
		}
