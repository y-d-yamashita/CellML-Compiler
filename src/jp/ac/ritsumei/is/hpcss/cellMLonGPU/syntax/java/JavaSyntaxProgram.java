 ...
 * @author n-washio
 */
public class JavaSyntaxProgram extends JavaSyntax {

	/**内部の構文*/
	protected Vector<JavaSyntaxPreprocessor> m_vecSynPreprocessor;
	protected Vector<JavaSyntaxDeclaration> m_vecSynDeclaration;
	protected Vector<JavaSyntaxFunction> m_vecSynFunction;

	/**
	 * プログラム構文インスタンスを作成する.
	 */
	public JavaSyntaxProgram() {
		super(eSyntaxClassification.SYN_JAVA_PROGRAM);
		m_vecSynPreprocessor = new Vector<JavaSyntaxPreprocessor>();
		m_vecSynDeclaration = new Vector<JavaSyntaxDeclaration>();
		m_vecSynFunction = new Vector<JavaSyntaxFunction>();
	}
	...
	throws MathException, SyntaxException {
		...
		{
			/*順次追加*/
			for (JavaSyntaxPreprocessor it: m_vecSynPreprocessor) {
				/*文字列追加*/
				strPresentText.append(it.toLegalJavaString() + StringUtil.lineSep);
			}
		}
		...
		{
			/*順次追加*/
			for (JavaSyntaxFunction it: m_vecSynFunction) {
				strPresentText.append(it.toLegalJavaString() + StringUtil.lineSep);
			}
		}
	 ...
	 */
	public void addPreprocessor(JavaSyntaxPreprocessor pPreprocessor) {
		//------------------------------------------
		//重複チェック
		//------------------------------------------
	 ...
	 */
	public void addFunction(JavaSyntaxFunction pFunction) {
		/*要素追加*/
