package simulation;
public class Luo_rudy_1991_RungeKutta4{
...
public static void main ( String args[] ) {
	...
	do{
		...
		Main_E_K1_i4[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  ( Main_Ko_z / Main_Ki_z )  ) ) ;
		Main_E_Kp_i4[n] = Main_E_K1_i4[n];
		Main_g_K1_i4[n] =  ( (double)0.6047 * Math.sqrt(  ( Main_Ko_z / (double)5.4 )  ) ) ;
		Main_E_K_i4[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  (  ( Main_Ko_z +  ( Main_PR_NaK_z * Main_Nao_z )  )  /  ( Main_Ki_z +  ( Main_PR_NaK_z * Main_Nai_z )  )  )  ) ) ;
		Main_g_K_i4[n] =  ( (double)0.282 * Math.sqrt(  ( Main_Ko_z / (double)5.4 )  ) ) ;
		Main_E_Na_i4[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  ( Main_Nao_z / Main_Nai_z )  ) ) ;
		Main_E_K1_i3[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  ( Main_Ko_z / Main_Ki_z )  ) ) ;
		Main_E_Kp_i3[n] = Main_E_K1_i3[n];
		Main_g_K1_i3[n] =  ( (double)0.6047 * Math.sqrt(  ( Main_Ko_z / (double)5.4 )  ) ) ;
		Main_E_K_i3[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  (  ( Main_Ko_z +  ( Main_PR_NaK_z * Main_Nao_z )  )  /  ( Main_Ki_z +  ( Main_PR_NaK_z * Main_Nai_z )  )  )  ) ) ;
		Main_g_K_i3[n] =  ( (double)0.282 * Math.sqrt(  ( Main_Ko_z / (double)5.4 )  ) ) ;
		Main_E_Na_i3[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  ( Main_Nao_z / Main_Nai_z )  ) ) ;
		Main_E_K1_i2[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  ( Main_Ko_z / Main_Ki_z )  ) ) ;
		Main_E_Kp_i2[n] = Main_E_K1_i2[n];
		Main_g_K1_i2[n] =  ( (double)0.6047 * Math.sqrt(  ( Main_Ko_z / (double)5.4 )  ) ) ;
		Main_E_K_i2[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  (  ( Main_Ko_z +  ( Main_PR_NaK_z * Main_Nao_z )  )  /  ( Main_Ki_z +  ( Main_PR_NaK_z * Main_Nai_z )  )  )  ) ) ;
		Main_g_K_i2[n] =  ( (double)0.282 * Math.sqrt(  ( Main_Ko_z / (double)5.4 )  ) ) ;
		Main_E_Na_i2[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  ( Main_Nao_z / Main_Nai_z )  ) ) ;
		Main_E_K1_i1[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  ( Main_Ko_z / Main_Ki_z )  ) ) ;
		Main_E_Kp_i1[n] = Main_E_K1_i1[n];
		Main_g_K1_i1[n] =  ( (double)0.6047 * Math.sqrt(  ( Main_Ko_z / (double)5.4 )  ) ) ;
		Main_E_K_i1[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  (  ( Main_Ko_z +  ( Main_PR_NaK_z * Main_Nao_z )  )  /  ( Main_Ki_z +  ( Main_PR_NaK_z * Main_Nai_z )  )  )  ) ) ;
		Main_g_K_i1[n] =  ( (double)0.282 * Math.sqrt(  ( Main_Ko_z / (double)5.4 )  ) ) ;
		Main_E_Na_i1[n] =  (  (  ( Main_R_z * Main_T_z )  / Main_F_z )  * Math.log(  ( Main_Nao_z / Main_Nai_z )  ) ) ;
		Main_time_t1[ ( n + 1 ) ] =  ( Main_time_t1[n] + d ) ;
		Main_time_t4[n] =  ( Main_time_t1[n] + d ) ;
		Main_I_stim_i4[n] =  (  (  ( Main_time_t4[n] >= Main_stim_start_z )  &&  ( Main_time_t4[n] <= Main_stim_end_z )  &&  (  (  ( Main_time_t4[n] - Main_stim_start_z )  -  ( Math.floor(  (  ( Main_time_t4[n] - Main_stim_start_z )  / Main_stim_period_z )  ) * Main_stim_period_z )  )  <= Main_stim_duration_z )  )  ? Main_stim_amplitude_z : (double)0 ) ;
		Main_time_t3[n] =  ( Main_time_t1[n] +  ( d / (double)2 )  ) ;
		Main_I_stim_i3[n] =  (  (  ( Main_time_t3[n] >= Main_stim_start_z )  &&  ( Main_time_t3[n] <= Main_stim_end_z )  &&  (  (  ( Main_time_t3[n] - Main_stim_start_z )  -  ( Math.floor(  (  ( Main_time_t3[n] - Main_stim_start_z )  / Main_stim_period_z )  ) * Main_stim_period_z )  )  <= Main_stim_duration_z )  )  ? Main_stim_amplitude_z : (double)0 ) ;
		Main_time_t2[n] =  ( Main_time_t1[n] +  ( d / (double)2 )  ) ;
		Main_I_stim_i2[n] =  (  (  ( Main_time_t2[n] >= Main_stim_start_z )  &&  ( Main_time_t2[n] <= Main_stim_end_z )  &&  (  (  ( Main_time_t2[n] - Main_stim_start_z )  -  ( Math.floor(  (  ( Main_time_t2[n] - Main_stim_start_z )  / Main_stim_period_z )  ) * Main_stim_period_z )  )  <= Main_stim_duration_z )  )  ? Main_stim_amplitude_z : (double)0 ) ;
		Main_I_stim_i1[n] =  (  (  ( Main_time_t1[n] >= Main_stim_start_z )  &&  ( Main_time_t1[n] <= Main_stim_end_z )  &&  (  (  ( Main_time_t1[n] - Main_stim_start_z )  -  ( Math.floor(  (  ( Main_time_t1[n] - Main_stim_start_z )  / Main_stim_period_z )  ) * Main_stim_period_z )  )  <= Main_stim_duration_z )  )  ? Main_stim_amplitude_z : (double)0 ) ;
		Main_E_si_i1[n] =  ( (double)7.7 -  ( (double)13.0287 * Math.log(  ( Main_Cai_x1[n] / (double)1 )  ) )  ) ;
		Main_i_b_i1[n] =  ( Main_g_b_z *  ( Main_V_x1[n] - Main_E_b_z )  ) ;
		Main_Kp_i1[n] =  ( (double)1 /  ( (double)1 + Math.exp(  (  ( (double)7.488 - Main_V_x1[n] )  / (double)5.98 )  ) )  ) ;
		Main_i_Kp_i1[n] =  ( Main_g_Kp_z * Main_Kp_i1[n] *  ( Main_V_x1[n] - Main_E_Kp_i1[n] )  ) ;
		Main_beta_K1_i1[n] =  (  (  ( (double)0.49124 * Math.exp(  ( (double)0.08032 *  (  ( Main_V_x1[n] + (double)5.476 )  - Main_E_K1_i1[n] )  )  ) )  +  ( (double)1 * Math.exp(  ( (double)0.06175 *  ( Main_V_x1[n] -  ( Main_E_K1_i1[n] + (double)594.31 )  )  )  ) )  )  /  ( (double)1 + Math.exp(  (  ( - (double)0.5143 )  *  (  ( Main_V_x1[n] - Main_E_K1_i1[n] )  + (double)4.753 )  )  ) )  ) ;
		Main_alpha_K1_i1[n] =  ( (double)1.02 /  ( (double)1 + Math.exp(  ( (double)0.2385 *  (  ( Main_V_x1[n] - Main_E_K1_i1[n] )  - (double)59.215 )  )  ) )  ) ;
		...
		Main_beta_X_i1[n] =  (  ( (double)0.0013 * Math.exp(  (  ( - (double)0.06 )  *  ( Main_V_x1[n] + (double)20 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.04 )  *  ( Main_V_x1[n] + (double)20 )  )  ) )  ) ;
		Main_alpha_X_i1[n] =  (  ( (double)0.0005 * Math.exp(  ( (double)0.083 *  ( Main_V_x1[n] + (double)50 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.057 *  ( Main_V_x1[n] + (double)50 )  )  ) )  ) ;
		...
		Main_Xi_i1[n] =  (  ( Main_V_x1[n] >  ( - (double)100 )  )  ?  (  ( (double)2.837 *  ( Math.exp(  ( (double)0.04 *  ( Main_V_x1[n] + (double)77 )  )  ) - (double)1 )  )  /  (  ( Main_V_x1[n] + (double)77 )  * Math.exp(  ( (double)0.04 *  ( Main_V_x1[n] + (double)35 )  )  ) )  )  : (double)1 ) ;
		Main_beta_f_i1[n] =  (  ( (double)0.0065 * Math.exp(  (  ( - (double)0.02 )  *  ( Main_V_x1[n] + (double)30 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.2 )  *  ( Main_V_x1[n] + (double)30 )  )  ) )  ) ;
		Main_i_K_i1[n] =  ( Main_g_K_i1[n] * Main_X_x1[n] * Main_Xi_i1[n] *  ( Main_V_x1[n] - Main_E_K_i1[n] )  ) ;
		Main_beta_d_i1[n] =  (  ( (double)0.07 * Math.exp(  (  ( - (double)0.017 )  *  ( Main_V_x1[n] + (double)44 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.05 *  ( Main_V_x1[n] + (double)44 )  )  ) )  ) ;
		Main_alpha_f_i1[n] =  (  ( (double)0.012 * Math.exp(  (  ( - (double)0.008 )  *  ( Main_V_x1[n] + (double)28 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.15 *  ( Main_V_x1[n] + (double)28 )  )  ) )  ) ;
		...
		Main_E_si_i2[n] =  ( (double)7.7 -  ( (double)13.0287 * Math.log(  ( Main_Cai_x2[n] / (double)1 )  ) )  ) ;
		Main_alpha_d_i1[n] =  (  ( (double)0.095 * Math.exp(  (  ( - (double)0.01 )  *  ( Main_V_x1[n] - (double)5 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.072 )  *  ( Main_V_x1[n] - (double)5 )  )  ) )  ) ;
		...
		Main_beta_j_i1[n] =  (  ( Main_V_x1[n] <  ( - (double)40 )  )  ?  (  ( (double)0.1212 * Math.exp(  (  ( - (double)0.01052 )  * Main_V_x1[n] )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.1378 )  *  ( Main_V_x1[n] + (double)40.14 )  )  ) )  )  :  (  ( (double)0.3 * Math.exp(  (  ( - (double)0.0000002535 )  * Main_V_x1[n] )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.1 )  *  ( Main_V_x1[n] + (double)32 )  )  ) )  )  ) ;
		Main_beta_h_i1[n] =  (  ( Main_V_x1[n] <  ( - (double)40 )  )  ?  (  ( (double)3.56 * Math.exp(  ( (double)0.079 * Main_V_x1[n] )  ) )  +  ( (double)310000 * Math.exp(  ( (double)0.35 * Main_V_x1[n] )  ) )  )  :  ( (double)1 /  ( (double)0.13 *  ( (double)1 + Math.exp(  (  ( Main_V_x1[n] + (double)10.66 )  /  ( - (double)11.1 )  )  ) )  )  )  ) ;
		Main_alpha_j_i1[n] =  (  ( Main_V_x1[n] <  ( - (double)40 )  )  ?  (  (  (  (  ( - (double)127140 )  * Math.exp(  ( (double)0.2444 * Main_V_x1[n] )  ) )  -  ( (double)0.00003474 * Math.exp(  (  ( - (double)0.04391 )  * Main_V_x1[n] )  ) )  )  *  ( Main_V_x1[n] + (double)37.78 )  )  /  ( (double)1 + Math.exp(  ( (double)0.311 *  ( Main_V_x1[n] + (double)79.23 )  )  ) )  )  : (double)0 ) ;
		...
		Main_beta_m_i1[n] =  ( (double)0.08 * Math.exp(  (  ( - Main_V_x1[n] )  / (double)11 )  ) ) ;
		Main_alpha_h_i1[n] =  (  ( Main_V_x1[n] <  ( - (double)40 )  )  ?  ( (double)0.135 * Math.exp(  (  ( (double)80 + Main_V_x1[n] )  /  ( - (double)6.8 )  )  ) )  : (double)0 ) ;
		...
		Main_i_Na_i1[n] =  ( Main_g_Na_z * Math.pow( Main_m_x1[n] , (double)3 ) * Main_h_x1[n] * Main_j_x1[n] *  ( Main_V_x1[n] - Main_E_Na_i1[n] )  ) ;
		...
		Main_alpha_K1_i2[n] =  ( (double)1.02 /  ( (double)1 + Math.exp(  ( (double)0.2385 *  (  ( Main_V_x2[n] - Main_E_K1_i2[n] )  - (double)59.215 )  )  ) )  ) ;
		Main_beta_K1_i2[n] =  (  (  ( (double)0.49124 * Math.exp(  ( (double)0.08032 *  (  ( Main_V_x2[n] + (double)5.476 )  - Main_E_K1_i2[n] )  )  ) )  +  ( (double)1 * Math.exp(  ( (double)0.06175 *  ( Main_V_x2[n] -  ( Main_E_K1_i2[n] + (double)594.31 )  )  )  ) )  )  /  ( (double)1 + Math.exp(  (  ( - (double)0.5143 )  *  (  ( Main_V_x2[n] - Main_E_K1_i2[n] )  + (double)4.753 )  )  ) )  ) ;
		...
		Main_Kp_i2[n] =  ( (double)1 /  ( (double)1 + Math.exp(  (  ( (double)7.488 - Main_V_x2[n] )  / (double)5.98 )  ) )  ) ;
		Main_i_Kp_i2[n] =  ( Main_g_Kp_z * Main_Kp_i2[n] *  ( Main_V_x2[n] - Main_E_Kp_i2[n] )  ) ;
		Main_beta_f_i2[n] =  (  ( (double)0.0065 * Math.exp(  (  ( - (double)0.02 )  *  ( Main_V_x2[n] + (double)30 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.2 )  *  ( Main_V_x2[n] + (double)30 )  )  ) )  ) ;
		Main_Xi_i2[n] =  (  ( Main_V_x2[n] >  ( - (double)100 )  )  ?  (  ( (double)2.837 *  ( Math.exp(  ( (double)0.04 *  ( Main_V_x2[n] + (double)77 )  )  ) - (double)1 )  )  /  (  ( Main_V_x2[n] + (double)77 )  * Math.exp(  ( (double)0.04 *  ( Main_V_x2[n] + (double)35 )  )  ) )  )  : (double)1 ) ;
		Main_i_K_i2[n] =  ( Main_g_K_i2[n] * Main_X_x2[n] * Main_Xi_i2[n] *  ( Main_V_x2[n] - Main_E_K_i2[n] )  ) ;
		Main_alpha_X_i2[n] =  (  ( (double)0.0005 * Math.exp(  ( (double)0.083 *  ( Main_V_x2[n] + (double)50 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.057 *  ( Main_V_x2[n] + (double)50 )  )  ) )  ) ;
		Main_beta_X_i2[n] =  (  ( (double)0.0013 * Math.exp(  (  ( - (double)0.06 )  *  ( Main_V_x2[n] + (double)20 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.04 )  *  ( Main_V_x2[n] + (double)20 )  )  ) )  ) ;
		...
		Main_beta_j_i2[n] =  (  ( Main_V_x2[n] <  ( - (double)40 )  )  ?  (  ( (double)0.1212 * Math.exp(  (  ( - (double)0.01052 )  * Main_V_x2[n] )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.1378 )  *  ( Main_V_x2[n] + (double)40.14 )  )  ) )  )  :  (  ( (double)0.3 * Math.exp(  (  ( - (double)0.0000002535 )  * Main_V_x2[n] )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.1 )  *  ( Main_V_x2[n] + (double)32 )  )  ) )  )  ) ;
		Main_alpha_j_i2[n] =  (  ( Main_V_x2[n] <  ( - (double)40 )  )  ?  (  (  (  (  ( - (double)127140 )  * Math.exp(  ( (double)0.2444 * Main_V_x2[n] )  ) )  -  ( (double)0.00003474 * Math.exp(  (  ( - (double)0.04391 )  * Main_V_x2[n] )  ) )  )  *  ( Main_V_x2[n] + (double)37.78 )  )  /  ( (double)1 + Math.exp(  ( (double)0.311 *  ( Main_V_x2[n] + (double)79.23 )  )  ) )  )  : (double)0 ) ;
		...
		Main_beta_h_i2[n] =  (  ( Main_V_x2[n] <  ( - (double)40 )  )  ?  (  ( (double)3.56 * Math.exp(  ( (double)0.079 * Main_V_x2[n] )  ) )  +  ( (double)310000 * Math.exp(  ( (double)0.35 * Main_V_x2[n] )  ) )  )  :  ( (double)1 /  ( (double)0.13 *  ( (double)1 + Math.exp(  (  ( Main_V_x2[n] + (double)10.66 )  /  ( - (double)11.1 )  )  ) )  )  )  ) ;
		Main_alpha_f_i2[n] =  (  ( (double)0.012 * Math.exp(  (  ( - (double)0.008 )  *  ( Main_V_x2[n] + (double)28 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.15 *  ( Main_V_x2[n] + (double)28 )  )  ) )  ) ;
		...
		Main_beta_d_i2[n] =  (  ( (double)0.07 * Math.exp(  (  ( - (double)0.017 )  *  ( Main_V_x2[n] + (double)44 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.05 *  ( Main_V_x2[n] + (double)44 )  )  ) )  ) ;
		Main_alpha_d_i2[n] =  (  ( (double)0.095 * Math.exp(  (  ( - (double)0.01 )  *  ( Main_V_x2[n] - (double)5 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.072 )  *  ( Main_V_x2[n] - (double)5 )  )  ) )  ) ;
		...
		Main_E_si_i3[n] =  ( (double)7.7 -  ( (double)13.0287 * Math.log(  ( Main_Cai_x3[n] / (double)1 )  ) )  ) ;
		Main_i_b_i2[n] =  ( Main_g_b_z *  ( Main_V_x2[n] - Main_E_b_z )  ) ;
		Main_alpha_h_i2[n] =  (  ( Main_V_x2[n] <  ( - (double)40 )  )  ?  ( (double)0.135 * Math.exp(  (  ( (double)80 + Main_V_x2[n] )  /  ( - (double)6.8 )  )  ) )  : (double)0 ) ;
		...
		Main_beta_m_i2[n] =  ( (double)0.08 * Math.exp(  (  ( - Main_V_x2[n] )  / (double)11 )  ) ) ;
		Main_alpha_m_i2[n] =  (  ( (double)0.32 *  ( Main_V_x2[n] + (double)47.13 )  )  /  ( (double)1 - Math.exp(  (  ( - (double)0.1 )  *  ( Main_V_x2[n] + (double)47.13 )  )  ) )  ) ;
		Main_alpha_m_i1[n] =  (  ( (double)0.32 *  ( Main_V_x1[n] + (double)47.13 )  )  /  ( (double)1 - Math.exp(  (  ( - (double)0.1 )  *  ( Main_V_x1[n] + (double)47.13 )  )  ) )  ) ;
		...
		Main_i_Na_i2[n] =  ( Main_g_Na_z * Math.pow( Main_m_x2[n] , (double)3 ) * Main_h_x2[n] * Main_j_x2[n] *  ( Main_V_x2[n] - Main_E_Na_i2[n] )  ) ;
		...
		Main_beta_h_i3[n] =  (  ( Main_V_x3[n] <  ( - (double)40 )  )  ?  (  ( (double)3.56 * Math.exp(  ( (double)0.079 * Main_V_x3[n] )  ) )  +  ( (double)310000 * Math.exp(  ( (double)0.35 * Main_V_x3[n] )  ) )  )  :  ( (double)1 /  ( (double)0.13 *  ( (double)1 + Math.exp(  (  ( Main_V_x3[n] + (double)10.66 )  /  ( - (double)11.1 )  )  ) )  )  )  ) ;
		Main_alpha_j_i3[n] =  (  ( Main_V_x3[n] <  ( - (double)40 )  )  ?  (  (  (  (  ( - (double)127140 )  * Math.exp(  ( (double)0.2444 * Main_V_x3[n] )  ) )  -  ( (double)0.00003474 * Math.exp(  (  ( - (double)0.04391 )  * Main_V_x3[n] )  ) )  )  *  ( Main_V_x3[n] + (double)37.78 )  )  /  ( (double)1 + Math.exp(  ( (double)0.311 *  ( Main_V_x3[n] + (double)79.23 )  )  ) )  )  : (double)0 ) ;
		Main_beta_j_i3[n] =  (  ( Main_V_x3[n] <  ( - (double)40 )  )  ?  (  ( (double)0.1212 * Math.exp(  (  ( - (double)0.01052 )  * Main_V_x3[n] )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.1378 )  *  ( Main_V_x3[n] + (double)40.14 )  )  ) )  )  :  (  ( (double)0.3 * Math.exp(  (  ( - (double)0.0000002535 )  * Main_V_x3[n] )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.1 )  *  ( Main_V_x3[n] + (double)32 )  )  ) )  )  ) ;
		...
		Main_E_si_i4[n] =  ( (double)7.7 -  ( (double)13.0287 * Math.log(  ( Main_Cai_x4[n] / (double)1 )  ) )  ) ;
		Main_alpha_d_i3[n] =  (  ( (double)0.095 * Math.exp(  (  ( - (double)0.01 )  *  ( Main_V_x3[n] - (double)5 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.072 )  *  ( Main_V_x3[n] - (double)5 )  )  ) )  ) ;
		Main_beta_d_i3[n] =  (  ( (double)0.07 * Math.exp(  (  ( - (double)0.017 )  *  ( Main_V_x3[n] + (double)44 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.05 *  ( Main_V_x3[n] + (double)44 )  )  ) )  ) ;
		Main_kd_k3[n] =  (  ( Main_alpha_d_i3[n] *  ( (double)1 - Main_d_x3[n] )  )  -  ( Main_beta_d_i3[n] * Main_d_x3[n] )  ) ;
		Main_d_x4[n] =  ( Main_d_x1[n] +  ( Main_kd_k3[n] * d )  ) ;
		Main_alpha_f_i3[n] =  (  ( (double)0.012 * Math.exp(  (  ( - (double)0.008 )  *  ( Main_V_x3[n] + (double)28 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.15 *  ( Main_V_x3[n] + (double)28 )  )  ) )  ) ;
		Main_i_b_i3[n] =  ( Main_g_b_z *  ( Main_V_x3[n] - Main_E_b_z )  ) ;
		Main_i_Na_i3[n] =  ( Main_g_Na_z * Math.pow( Main_m_x3[n] , (double)3 ) * Main_h_x3[n] * Main_j_x3[n] *  ( Main_V_x3[n] - Main_E_Na_i3[n] )  ) ;
		Main_alpha_m_i3[n] =  (  ( (double)0.32 *  ( Main_V_x3[n] + (double)47.13 )  )  /  ( (double)1 - Math.exp(  (  ( - (double)0.1 )  *  ( Main_V_x3[n] + (double)47.13 )  )  ) )  ) ;
		Main_beta_m_i3[n] =  ( (double)0.08 * Math.exp(  (  ( - Main_V_x3[n] )  / (double)11 )  ) ) ;
		Main_km_k3[n] =  (  ( Main_alpha_m_i3[n] *  ( (double)1 - Main_m_x3[n] )  )  -  ( Main_beta_m_i3[n] * Main_m_x3[n] )  ) ;
		Main_m_x4[n] =  ( Main_m_x1[n] +  ( Main_km_k3[n] * d )  ) ;
		Main_alpha_h_i3[n] =  (  ( Main_V_x3[n] <  ( - (double)40 )  )  ?  ( (double)0.135 * Math.exp(  (  ( (double)80 + Main_V_x3[n] )  /  ( - (double)6.8 )  )  ) )  : (double)0 ) ;
		Main_kh_k3[n] =  (  ( Main_alpha_h_i3[n] *  ( (double)1 - Main_h_x3[n] )  )  -  ( Main_beta_h_i3[n] * Main_h_x3[n] )  ) ;
		Main_h_x4[n] =  ( Main_h_x1[n] +  ( Main_kh_k3[n] * d )  ) ;
		Main_Xi_i3[n] =  (  ( Main_V_x3[n] >  ( - (double)100 )  )  ?  (  ( (double)2.837 *  ( Math.exp(  ( (double)0.04 *  ( Main_V_x3[n] + (double)77 )  )  ) - (double)1 )  )  /  (  ( Main_V_x3[n] + (double)77 )  * Math.exp(  ( (double)0.04 *  ( Main_V_x3[n] + (double)35 )  )  ) )  )  : (double)1 ) ;
		Main_alpha_X_i3[n] =  (  ( (double)0.0005 * Math.exp(  ( (double)0.083 *  ( Main_V_x3[n] + (double)50 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.057 *  ( Main_V_x3[n] + (double)50 )  )  ) )  ) ;
		Main_beta_X_i3[n] =  (  ( (double)0.0013 * Math.exp(  (  ( - (double)0.06 )  *  ( Main_V_x3[n] + (double)20 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.04 )  *  ( Main_V_x3[n] + (double)20 )  )  ) )  ) ;
		...
		Main_beta_f_i3[n] =  (  ( (double)0.0065 * Math.exp(  (  ( - (double)0.02 )  *  ( Main_V_x3[n] + (double)30 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.2 )  *  ( Main_V_x3[n] + (double)30 )  )  ) )  ) ;
		Main_kf_k3[n] =  (  ( Main_alpha_f_i3[n] *  ( (double)1 - Main_f_x3[n] )  )  -  ( Main_beta_f_i3[n] * Main_f_x3[n] )  ) ;
		Main_f_x4[n] =  ( Main_f_x1[n] +  ( Main_kf_k3[n] * d )  ) ;
		Main_Kp_i3[n] =  ( (double)1 /  ( (double)1 + Math.exp(  (  ( (double)7.488 - Main_V_x3[n] )  / (double)5.98 )  ) )  ) ;
		Main_i_Kp_i3[n] =  ( Main_g_Kp_z * Main_Kp_i3[n] *  ( Main_V_x3[n] - Main_E_Kp_i3[n] )  ) ;
		Main_alpha_K1_i3[n] =  ( (double)1.02 /  ( (double)1 + Math.exp(  ( (double)0.2385 *  (  ( Main_V_x3[n] - Main_E_K1_i3[n] )  - (double)59.215 )  )  ) )  ) ;
		Main_beta_K1_i3[n] =  (  (  ( (double)0.49124 * Math.exp(  ( (double)0.08032 *  (  ( Main_V_x3[n] + (double)5.476 )  - Main_E_K1_i3[n] )  )  ) )  +  ( (double)1 * Math.exp(  ( (double)0.06175 *  ( Main_V_x3[n] -  ( Main_E_K1_i3[n] + (double)594.31 )  )  )  ) )  )  /  ( (double)1 + Math.exp(  (  ( - (double)0.5143 )  *  (  ( Main_V_x3[n] - Main_E_K1_i3[n] )  + (double)4.753 )  )  ) )  ) ;
		...
		Main_beta_X_i4[n] =  (  ( (double)0.0013 * Math.exp(  (  ( - (double)0.06 )  *  ( Main_V_x4[n] + (double)20 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.04 )  *  ( Main_V_x4[n] + (double)20 )  )  ) )  ) ;
		Main_alpha_X_i4[n] =  (  ( (double)0.0005 * Math.exp(  ( (double)0.083 *  ( Main_V_x4[n] + (double)50 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.057 *  ( Main_V_x4[n] + (double)50 )  )  ) )  ) ;
		...
		Main_Xi_i4[n] =  (  ( Main_V_x4[n] >  ( - (double)100 )  )  ?  (  ( (double)2.837 *  ( Math.exp(  ( (double)0.04 *  ( Main_V_x4[n] + (double)77 )  )  ) - (double)1 )  )  /  (  ( Main_V_x4[n] + (double)77 )  * Math.exp(  ( (double)0.04 *  ( Main_V_x4[n] + (double)35 )  )  ) )  )  : (double)1 ) ;
		Main_beta_f_i4[n] =  (  ( (double)0.0065 * Math.exp(  (  ( - (double)0.02 )  *  ( Main_V_x4[n] + (double)30 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.2 )  *  ( Main_V_x4[n] + (double)30 )  )  ) )  ) ;
		Main_i_K_i4[n] =  ( Main_g_K_i4[n] * Main_X_x4[n] * Main_Xi_i4[n] *  ( Main_V_x4[n] - Main_E_K_i4[n] )  ) ;
		Main_Kp_i4[n] =  ( (double)1 /  ( (double)1 + Math.exp(  (  ( (double)7.488 - Main_V_x4[n] )  / (double)5.98 )  ) )  ) ;
		Main_i_Kp_i4[n] =  ( Main_g_Kp_z * Main_Kp_i4[n] *  ( Main_V_x4[n] - Main_E_Kp_i4[n] )  ) ;
		Main_beta_K1_i4[n] =  (  (  ( (double)0.49124 * Math.exp(  ( (double)0.08032 *  (  ( Main_V_x4[n] + (double)5.476 )  - Main_E_K1_i4[n] )  )  ) )  +  ( (double)1 * Math.exp(  ( (double)0.06175 *  ( Main_V_x4[n] -  ( Main_E_K1_i4[n] + (double)594.31 )  )  )  ) )  )  /  ( (double)1 + Math.exp(  (  ( - (double)0.5143 )  *  (  ( Main_V_x4[n] - Main_E_K1_i4[n] )  + (double)4.753 )  )  ) )  ) ;
		Main_alpha_K1_i4[n] =  ( (double)1.02 /  ( (double)1 + Math.exp(  ( (double)0.2385 *  (  ( Main_V_x4[n] - Main_E_K1_i4[n] )  - (double)59.215 )  )  ) )  ) ;
		...
		Main_i_Na_i4[n] =  ( Main_g_Na_z * Math.pow( Main_m_x4[n] , (double)3 ) * Main_h_x4[n] * Main_j_x4[n] *  ( Main_V_x4[n] - Main_E_Na_i4[n] )  ) ;
		Main_alpha_m_i4[n] =  (  ( (double)0.32 *  ( Main_V_x4[n] + (double)47.13 )  )  /  ( (double)1 - Math.exp(  (  ( - (double)0.1 )  *  ( Main_V_x4[n] + (double)47.13 )  )  ) )  ) ;
		Main_beta_m_i4[n] =  ( (double)0.08 * Math.exp(  (  ( - Main_V_x4[n] )  / (double)11 )  ) ) ;
		...
		Main_alpha_h_i4[n] =  (  ( Main_V_x4[n] <  ( - (double)40 )  )  ?  ( (double)0.135 * Math.exp(  (  ( (double)80 + Main_V_x4[n] )  /  ( - (double)6.8 )  )  ) )  : (double)0 ) ;
		...
		Main_alpha_d_i4[n] =  (  ( (double)0.095 * Math.exp(  (  ( - (double)0.01 )  *  ( Main_V_x4[n] - (double)5 )  )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.072 )  *  ( Main_V_x4[n] - (double)5 )  )  ) )  ) ;
		Main_beta_d_i4[n] =  (  ( (double)0.07 * Math.exp(  (  ( - (double)0.017 )  *  ( Main_V_x4[n] + (double)44 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.05 *  ( Main_V_x4[n] + (double)44 )  )  ) )  ) ;
		...
		Main_alpha_f_i4[n] =  (  ( (double)0.012 * Math.exp(  (  ( - (double)0.008 )  *  ( Main_V_x4[n] + (double)28 )  )  ) )  /  ( (double)1 + Math.exp(  ( (double)0.15 *  ( Main_V_x4[n] + (double)28 )  )  ) )  ) ;
		...
		Main_beta_h_i4[n] =  (  ( Main_V_x4[n] <  ( - (double)40 )  )  ?  (  ( (double)3.56 * Math.exp(  ( (double)0.079 * Main_V_x4[n] )  ) )  +  ( (double)310000 * Math.exp(  ( (double)0.35 * Main_V_x4[n] )  ) )  )  :  ( (double)1 /  ( (double)0.13 *  ( (double)1 + Math.exp(  (  ( Main_V_x4[n] + (double)10.66 )  /  ( - (double)11.1 )  )  ) )  )  )  ) ;
		...
		Main_alpha_j_i4[n] =  (  ( Main_V_x4[n] <  ( - (double)40 )  )  ?  (  (  (  (  ( - (double)127140 )  * Math.exp(  ( (double)0.2444 * Main_V_x4[n] )  ) )  -  ( (double)0.00003474 * Math.exp(  (  ( - (double)0.04391 )  * Main_V_x4[n] )  ) )  )  *  ( Main_V_x4[n] + (double)37.78 )  )  /  ( (double)1 + Math.exp(  ( (double)0.311 *  ( Main_V_x4[n] + (double)79.23 )  )  ) )  )  : (double)0 ) ;
		Main_beta_j_i4[n] =  (  ( Main_V_x4[n] <  ( - (double)40 )  )  ?  (  ( (double)0.1212 * Math.exp(  (  ( - (double)0.01052 )  * Main_V_x4[n] )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.1378 )  *  ( Main_V_x4[n] + (double)40.14 )  )  ) )  )  :  (  ( (double)0.3 * Math.exp(  (  ( - (double)0.0000002535 )  * Main_V_x4[n] )  ) )  /  ( (double)1 + Math.exp(  (  ( - (double)0.1 )  *  ( Main_V_x4[n] + (double)32 )  )  ) )  )  ) ;
		...
		System.out.print(Main_V_x1[n+1]);
		System.out.println();
